  ...
  $(window).on("load", function () {
    ...
    */
    function checkTextAreaMaxLength(textBox, e) {
      ...
      $(".char-count")(textBox.value.length);
    ...
    if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
      ...
      if (value != "") {
        ...
        $.getJSON("../../../app-assets/data/" + $filename + ".json", function (
          ...
          $defaultList = $(".main-search-list-defaultlist")();
          if ($startList == "" && $otherList == "") {
            $otherList = $(".main-search-list-defaultlist-other-list")();
          }
          // concatinating startlist, otherlist, defalutlist with pagelist
          $htmlList = $pageList.concat($startList, $otherList, $defaultList);
          $("ul.search-list")($htmlList);
          // concatinating otherlist with startlist
          $bookmarkhtmlList = $startList.concat($otherList);
          $("ul.search-list-bookmark")($bookmarkhtmlList);
        });
      } else {
        if (bookmark === true) {
